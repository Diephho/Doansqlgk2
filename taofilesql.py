...
for file in file_list:
    ...
    with open(os.path.join(folder_path, sql_file_name), 'w', encoding='utf-16') as f:
        ...
        for index, row in df.iterrows():
            ...
            # Tạo câu lệnh INSERT
            newRow = row
            insert_sql = f"INSERT IGNORE INTO TRUONG (MATRUONG, TENTRUONG, MASO, MAPHONG, DIACHI, MA_LOAI_HINH, MA_LOAI_TRUONG) VALUES ('{newRow['Mã trường']}', '{newRow['Tên trường']}', '{newRow['Sở GD&ĐT']}', '{newRow['Phòng GD&ĐT']}', '{newRow['Địa chỉ']}', '{newRow['Loại hình']}', '{newRow['Loại trường']}');\n"
